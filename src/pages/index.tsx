  ...
  return (
    <MainLayout>
      <div className="absolute flex flex-col justify-center w-full h-screen px-4 -top-2">
        ...
        <Link href="/dining">
          <button className="flex items-center justify-between w-full p-4 my-4 text-lg font-bold duration-200 ease-in-out rounded-lg shadow-md items-centertransition text-amber-100 bg-amber-900 dark:text-amber-900 sm:text-xl focus:outline-none focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-amber-500 hover:brightness-75 dark:bg-amber-100 dark:hover:brightness-75 hover:scale-105">
            <span className="text-3xl font-bold">[</span>
            <span>
